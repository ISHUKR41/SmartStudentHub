...
export default function Signup() {
  ...
  const handleGoogleSignup = () => {
    ...
    toast({
      ...
      description:
        "Please authenticate with Google to complete your registration...",
      variant: "default",
    });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/10 to-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div
        className={`w-full max-w-lg space-y-6 transition-all duration-1000 transform ${
      ...
      >
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-sm">
              Register your academic credentials to access the Student
              Achievement Management System with institutional verification.
            </p>
          </div>
        </div>
        ...
        <Card className="shadow-xl border-0 bg-card/95 backdrop-blur-sm hover:shadow-2xl transition-all duration-300 group">
          <CardHeader className="space-y-2 pb-6">
            <CardTitle className="text-xl font-semibold text-center group-hover:scale-105 transition-transform duration-300">
              Student Registration
            </CardTitle>
            <CardDescription className="text-center text-sm">
              Complete your academic profile to access institutional achievement
              tracking and portfolio generation services
            </CardDescription>
          </CardHeader>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription className="text-xs">
                          Please provide your official Higher Education
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription className="text-xs">
                          Enter your official student enrollment number as
                          recorded in institutional academic records
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  {progressPercentage === 100 && (
                    <div className="text-center">
                      <div className="inline-flex items-center space-x-2 text-xs text-green-600 bg-green-50 dark:bg-green-900/20 rounded-full px-3 py-1 animate-in fade-in duration-500">
                        <CheckCircle className="w-3 h-3" />
                        <span>
                          All information completed - ready to register!
                        </span>
                      </div>
                    </div>
                  )}
